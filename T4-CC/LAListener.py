...
class LAListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LAParser#parcela_unaria.
    def enterParcela_unaria(self, ctx:LAParser.Parcela_unariaContext):
        pass

    # Exit a parse tree produced by LAParser#parcela_unaria.
    def exitParcela_unaria(self, ctx:LAParser.Parcela_unariaContext):
        pass


    # Enter a parse tree produced by LAParser#parcela_nao_unaria.
    def enterParcela_nao_unaria(self, ctx:LAParser.Parcela_nao_unariaContext):
        pass

    # Exit a parse tree produced by LAParser#parcela_nao_unaria.
    def exitParcela_nao_unaria(self, ctx:LAParser.Parcela_nao_unariaContext):
        pass
